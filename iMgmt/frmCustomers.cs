        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string cb = "insert into Customer(CustomerID,Customername,address,landmark,city,state,zipcode,Phone,email,mobileno,TIN,notes) VALUES (@d1,@d2,@d4,@d5,@d6,@d7,@d8,@d9,@d10,@d11,@d12,@d13)";
                    ...
                    cmd.Parameters.Add(new OleDbParameter("@d12", System.Data.OleDb.OleDbType.VarChar, 15, "TIN"));
                    ...
                    cmd.Parameters["@d12"].Value = txtTIN.Text;
