...
namespace iMgmt {
    ...
    public partial class SIS_DBDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomerRow AddCustomerRow(string CustomerID, string CustomerName, string Address, string Landmark, string City, string State, int ZipCode, string Phone, string MobileNo, string TIN, string Email, string Notes) {
        ...
        public partial class CustomerRow : global::System.Data.DataRow {
            ...
            public string TIN {
                get {
                    try {
                        return ((string)(this[this.tableCustomer.TINColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableCustomer.TINColumn] = value;
                }
            }
            ...
            public bool IsTINNull() {
                return this.IsNull(this.tableCustomer.TINColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetTINNull() {
                this[this.tableCustomer.TINColumn] = global::System.Convert.DBNull;
            }
...
namespace iMgmt.SIS_DBDataSetTableAdapters {
    ...
    public partial class CategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::iMgmt.Properties.Settings.Default.SIS_DBConnectionString;
        }
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Customer` (`CustomerID`, `CustomerName`, `Address`, `Landmark`, `Cit" +
                "y`, `State`, `ZipCode`, `Phone`, `MobileNo`, `TIN`, `Email`, `Notes`) VALUES (?," +
                " ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Customer` SET `CustomerID` = ?, `CustomerName` = ?, `Address` = ?, `Landmark` = ?, `City` = ?, `State` = ?, `ZipCode` = ?, `Phone` = ?, `MobileNo` = ?, `TIN` = ?, `Email` = ?, `Notes` = ? WHERE ((`CustomerID` = ?) AND ((? = 1 AND `CustomerName` IS NULL) OR (`CustomerName` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Landmark` IS NULL) OR (`Landmark` = ?)) AND ((? = 1 AND `City` IS NULL) OR (`City` = ?)) AND ((? = 1 AND `State` IS NULL) OR (`State` = ?)) AND ((? = 1 AND `ZipCode` IS NULL) OR (`ZipCode` = ?)) AND ((? = 1 AND `Phone` IS NULL) OR (`Phone` = ?)) AND ((? = 1 AND `MobileNo` IS NULL) OR (`MobileNo` = ?)) AND ((? = 1 AND `TIN` IS NULL) OR (`TIN` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Notes` IS NULL) OR (`Notes` = ?)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, CustomerName, Address, Landmark, City, State, ZipCode, Phone, " +
                "MobileNo, TIN, Email, Notes FROM Customer";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(string Original_CustomerID, string Original_CustomerName, string Original_Address, string Original_Landmark, string Original_City, string Original_State, global::System.Nullable<int> Original_ZipCode, string Original_Phone, string Original_MobileNo, string Original_TIN, string Original_Email, string Original_Notes) {
            ...
            if ((Original_TIN == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[18].Value = ((string)(Original_TIN));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string CustomerID, string CustomerName, string Address, string Landmark, string City, string State, global::System.Nullable<int> ZipCode, string Phone, string MobileNo, string TIN, string Email, string Notes) {
            if ((CustomerID == null)) {
                this.Adapter.InsertCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
            ...
            if ((TIN == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[9].Value = ((string)(TIN));
            }
            if ((Email == null)) {
        ...
        public virtual int Update(
            ...
            if ((TIN == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(TIN));
            }
            if ((Email == null)) {
            ...
            if ((Original_TIN == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[30].Value = ((string)(Original_TIN));
            }
            if ((Original_Email == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_Email, 
                    string Original_Notes) {
            return this.Update(Original_CustomerID, CustomerName, Address, Landmark, City, State, ZipCode, Phone, MobileNo, TIN, Email, Notes, Original_CustomerID, Original_CustomerName, Original_Address, Original_Landmark, Original_City, Original_State, Original_ZipCode, Original_Phone, Original_MobileNo, Original_TIN, Original_Email, Original_Notes);
        }
    }
